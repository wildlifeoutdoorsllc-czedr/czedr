...
## Jibber Talk (live progress board)

**`START-JIBBER.cmd`** → **http://127.0.0.1:8791/**

Use this so later AIs can **read status and next actions** without a full re-brief. Guide: **`docs/JIBBER-TALK.md`**. Server move plan: **`docs/PROJECTS-ON-SERVER.md`**.
...
**`START-JIBBER.cmd`** starts the progress board on port **8791**.
...
- Live copy to OneVPS needs working SSH (**port 22122**) — password stays in your panel / Notepad, not in chat.

---

*One step:* Double-click **`START-JIBBER.cmd`**, then open a **new Cursor chat** and say “Atlas — read docs/AI-TEAM.md and docs/JIBBER-TALK.md”.
